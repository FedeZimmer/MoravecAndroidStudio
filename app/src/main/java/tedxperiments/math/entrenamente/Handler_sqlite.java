...
public class Handler_sqlite {

	private static final String DATABASE_NAME = "Data2110.db";
    private static final String DATABASE_TABLE = "ExperimentalData";
    private static final int DATABASE_VERSION = 1;
    
	public static final String KEY_TOSEND = "Data_to_Send";
    ...
    public Handler_sqlite open() throws SQLException {
    ...
    public long insertValues(String NewData) {
    	...
    	valores.put(KEY_TOSEND, NewData);//ACA tiene que ir el JSON
		valores.put(KEY_SENT, 0);//el cero quiere decir que no se mando
   ...
   public boolean deleteReminder(long rowId) {
	   //No se tiene que borrar por rowId, sino la que tiene un 1 en enviado
    ...
    public Cursor fetchAllReminders() {
        ...
        return mDb.query(DATABASE_TABLE, new String[] {KEY_ROWID, KEY_TOSEND,KEY_SENT
    ...
    public Cursor fetchReminder(long rowId) throws SQLException {
        ...
        Cursor mCursor =
                ...
                mDb.query(true, DATABASE_TABLE, new String[] {KEY_ROWID,
                        KEY_TOSEND, KEY_SENT}, KEY_ROWID + "=" + rowId, null,
                        null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
    ...
    public boolean updateReminder(long rowId) {
       ...
       //args.put(KEY_TOSEND, body);
       args.put(KEY_SENT, 1);//Estaria aclarando que se mando
